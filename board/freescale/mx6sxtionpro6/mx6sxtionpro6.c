...
static iomux_v3_cfg_t const fec1_pads[] = {
	...
	MX6_PAD_RGMII1_RXC__ENET1_RX_CLK | MUX_PAD_CTRL(PAD_CTL_PUS_47K_UP | PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_SPEED_HIGH   | PAD_CTL_SRE_FAST),
...
static iomux_v3_cfg_t const fec2_pads[] = {
	...
	MX6_PAD_RGMII2_RXC__ENET2_RX_CLK | MUX_PAD_CTRL(PAD_CTL_PUS_47K_UP | PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_SPEED_HIGH   | PAD_CTL_SRE_FAST),
...
int board_mmc_init(bd_t *bis)
{
	...
	for (i = 0; i < CONFIG_SYS_FSL_USDHC_NUM; i++) {
		...
		if (ret) {
				...
				return ret;
			} else printf("Info: initialized mmc dev %d\n", i);
	}
